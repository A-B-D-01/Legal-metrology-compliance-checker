...
export default function LoginPage() {
  ...
  return (
    <div className="max-w-md mx-auto mt-16 p-8 bg-zinc-900/90 backdrop-blur-2xl rounded-2xl border border-zinc-800 shadow-[0_0_50px_rgba(0,0,0,0.8)] relative">
      ...
      <p className="text-zinc-400 text-xs tracking-wide uppercase mb-6">Sign in to your regulatory intelligence portal</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            type="email"
            required
            className="w-full px-4 py-3 bg-zinc-950 border border-zinc-800 rounded-xl text-white placeholder-zinc-600 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all text-sm"
        ...
        <div>
          <label className="block text-xs font-semibold tracking-wider uppercase text-zinc-400 mb-1.5">Password</label>
          <input
            type="password"
            required
            className="w-full px-4 py-3 bg-zinc-950 border border-zinc-800 rounded-xl text-white placeholder-zinc-600 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all text-sm"
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3 mt-2 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-zinc-950 font-bold uppercase tracking-wider text-xs rounded-xl shadow-lg shadow-emerald-950/50 transition-all transform active:scale-[0.98] disabled:opacity-50"
        >
